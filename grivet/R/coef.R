...
#' @title Coefficient Estimation Implementation
#' @description This function implements coefficient estimation. 
#' @param X A n*q matrix for intervention variables.
#' @param Y A n*p matrix for primary variables.
#' @param Pi A matrix representing non-zero elements' indices for U.
#' @param Phi A matrix representing non-zero elements' indices for W.
#' @param Piv A matrix representing non-zero elements' indices for candidate IVs.
...
#' @return A list consists of the estimates of U,W and covariance matrix as well as selected taus and gammas.
...
#' @title Structure Learning Implementation
#' @description This function implements coefficient estimation, however, the parameter of interests are also penalized.  
#' @param X A n*q matrix for intervention variables.
#' @param Y A n*p matrix for primary variables.
#' @param Pi A matrix representing non-zero elements' indices for U.
#' @param Phi A matrix representing non-zero elements' indices for W.
