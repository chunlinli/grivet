...
write.csv(stats_hub,file.path("./part3/setting2/","stats_hub1.csv"),row.names = FALSE)
...
stats.hub <- parLapply(cl,1:1000,function(i){set.seed(i);try(stat<-simu(i),stat<-rep(-1,len.test));return(stat)})
stats_hub <- matrix(unlist(stats.hub),byrow = TRUE,ncol=6)
write.csv(stats_hub,file.path("./part3/setting2/","stats_hub2.csv"),row.names = FALSE)
...
stats.hub <- parLapply(cl,1:1000,function(i){set.seed(i);try(stat<-simu(i),stat<-rep(-1,len.test));return(stat)})
stats_hub <- matrix(unlist(stats.hub),byrow = TRUE,ncol=6)
write.csv(stats_hub,file.path("./part3/setting2/","stats_hub3.csv"),row.names = FALSE)
...
stats.hub <- parLapply(cl,1:1000,function(i){set.seed(i);try(stat<-simu(i),stat<-rep(-1,len.test));return(stat)})
stats_hub <- matrix(unlist(stats.hub),byrow = TRUE,ncol=6)
write.csv(stats_hub,file.path("./part3/setting2/","stats_hub4.csv"),row.names = FALSE)
...
stats.hub <- parLapply(cl,1:1000,function(i){set.seed(i);try(stat<-simu(i),stat<-rep(-1,len.test));return(stat)})
stats_hub <- matrix(unlist(stats.hub),byrow = TRUE,ncol=6)
write.csv(stats_hub,file.path("./part3/setting2/","stats_hub5.csv"),row.names = FALSE)
...
stats.hub <- parLapply(cl,1:1000,function(i){set.seed(i);try(stat<-simu(i),stat<-rep(-1,len.test));return(stat)})
stats_hub <- matrix(unlist(stats.hub),byrow = TRUE,ncol=6)
write.csv(stats_hub,file.path("./part3/setting2/","stats_hub6.csv"),row.names = FALSE)
